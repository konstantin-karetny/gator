    ...
    <div class="container">
        ...
        <table>
            ...
            <?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    <td><?php echo e(++$i); ?></td>
                    <td><a href="<?php echo e(route('meme.edit', $item->id)); ?>" title="<?php echo app('translator')->getFromJson('app.edit'); ?>"><?php echo e($item->name); ?></a></td>
                    <td><?php echo e($item->alias); ?></td>
                    <td><a class="external_link" href="<?php echo e($item->url); ?>" target="_blank"><?php echo e($item->url); ?></a></td>
                    <td>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\OSPanel\domains\gator\trunk\resources\views/meme/meme/index.blade.php ENDPATH**/ ?>